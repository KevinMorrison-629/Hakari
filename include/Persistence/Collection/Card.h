...
public:
    ...
    Card(const std::string &_id, const std::string &_name, const std::string &_characterId, const std::string &_setId,
         const std::string &_tierId, const std::string &_imageUrl, int32_t _numAcquired)
    {
        setId(_id);
        setName(_name);
