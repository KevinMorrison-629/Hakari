...
{
public:
    // Deregister all Commands with the Bot
    ...
    std::vector<SlashCommandEntry> m_CommandMap =
        {
            ...
            // SlashCommandEntry("trade", trade, "Make a trade with another player. \"!TRADE OFFER!: I get ___. You Receive ___.\""),
            // SlashCommandEntry("inventory", inventory, "Show your inventory. \"What have you gots in your pocketses\""),
            // SlashCommandEntry("itemshop", itemshop, "Display the Item Shop. \"I'll take one of those *points*\""),
            // SlashCommandEntry("gemshop", gemshop, "Display the Gem Shop. \"I've been saving up years for this upgrade!\""),
            // SlashCommandEntry("useitem", useitem, "Use an item from your inventory. \"What does this do again?\""),
            // SlashCommandEntry("userinfo", userinfo, "Display some user info/stats. Let's see if you are a degenerate. . ."),
            // SlashCommandEntry("serverinfo", serverinfo, "Display some server info/stats."),
